...
if [ -f "./app/build.gradle.kts" ]; then
    sed -i 's/outputFileName = "KernelSU_${managerVersionName}_${managerVersionCode}-\$name.apk"/outputFileName = "ꑄℭѧᝰ.ᐟ_${managerVersionName}_${managerVersionCode}-\$name.apk"/' ./app/build.gradle.kts
fi
